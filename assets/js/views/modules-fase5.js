...
(function () {
  ...
  const NT_INF_CSS = `
    ...
    .nt-inf__kpis{ display:grid;grid-template-columns:repeat(4,1fr);gap:9px;margin:16px auto 8px;max-width:640px; }
    .nt-inf__kpi{ border:1px solid #e2e9f0;border-radius:10px;padding:9px 7px;display:flex;flex-direction:column;align-items:center;gap:2px; }
    ...
    .nt-inf__varline{ margin:8px auto 14px;font-size:.84rem;color:#40536f }
    .nt-inf__var{ font-weight:800 } .nt-inf__var--up{ color:#1f9d57 } .nt-inf__var--down{ color:#c62f3b } .nt-inf__var--eq{ color:#8a94a6 }
    .nt-inf__tbl{ border-collapse:collapse;width:100%;max-width:640px;margin:8px auto;font-size:.8rem }
    .nt-inf__tbl th{ background:#0f8f83;color:#fff;padding:6px 8px;border:1px solid #cdd8e2;text-align:center }
    .nt-inf__tbl td{ padding:5px 8px;border:1px solid #e2e9f0;text-align:center }
    .nt-inf__tbl .l{ text-align:left }
    .nt-inf__kpis--3{ grid-template-columns:repeat(3,1fr);max-width:500px }
    .nt-inf__epi-h{ max-width:640px;margin:22px auto 6px;text-align:center;display:flex;align-items:center;justify-content:center;gap:10px }
    ...
    .nt-inf__obs{ max-width:640px;margin:20px auto 0;text-align:left }
    .nt-inf__obs-t{ font-family:'Fraunces',Georgia,serif;font-weight:700;color:#0f8f83;font-size:.94rem;margin-bottom:5px }
    .nt-inf__obs-box{ border:1px solid #dbe6f2;border-radius:8px;min-height:54px;padding:9px 12px;color:#22303a;font-size:.84rem;line-height:1.45 }
    .nt-inf__firmas{ display:flex;justify-content:center;gap:90px;margin-top:52px;flex-wrap:wrap }
    .nt-inf__firma{ text-align:center;min-width:240px }
    .nt-inf__line{ width:230px;border-top:1px solid #17263d;margin:40px auto 6px }
