...
(function () {
  ...
  function load() {
    ...
    s.all("guiasBPSO").forEach(g => {
      const map = {
        "Lesiones por presión": "UTI, UCI, Medicina",
        "Accesos vasculares": "UCI, UTI",
        "Dolor": "Urgencia Adulto, Medicina"
      };
    ...
    add("evaluacionesRNAO", [
      ...
      { anio: 2026, periodo: "2026-S1", fecha: iso(28), tipo: "Seguimiento", guia: "Accesos vasculares", unidad: "UCI",
      ...
      { anio: 2026, periodo: "2026-S1", fecha: iso(21), tipo: "Seguimiento", guia: "Dolor", unidad: "Urgencia Adulto",
      ...
      { anio: 2026, periodo: "2026-S1", fecha: iso(15), tipo: "Línea base", guia: "Lesiones por presión", unidad: "Medicina",
        frecuencia: "Semestral", fuente: "Auditoría de fichas", responsable: "EU. Carolina Reyes", referente: "EU. Marcos Soto",
    ...
    add("accionesRNAO", [
      ...
      { guia: "Dolor", unidad: "Urgencia Adulto", indicadorOrigen: "Reevaluación posterior a la intervención",
      ...
      { guia: "Lesiones por presión", unidad: "Medicina", indicadorOrigen: "Reevaluación según condición clínica",
    ...
    add("redChampion", [
      ...
      { nombre: "EU. Diego Fuentes", estamento: "Enfermería", unidad: "UCI", guia: "Accesos vasculares", contacto: "anexo 2360", estado: "Activo" },
      { nombre: "EU. Paula Núñez", estamento: "Enfermería", unidad: "Urgencia Adulto", guia: "Dolor", contacto: "anexo 2372", estado: "Activo" },
      { nombre: "TENS Luis Vera", estamento: "TENS", unidad: "Medicina", guia: "Lesiones por presión", contacto: "anexo 2388", estado: "Inactivo" }
    ], { silent: true });
    ...
    add("apoyoMejora", [
      ...
      { responsable: "EU. Marcos Soto", unidad: "UCI", problema: "Vigilancia de accesos vasculares no estandarizada.",
      ...
      { responsable: "EU. Carolina Reyes", unidad: "Urgencia Adulto", problema: "Valoración de dolor no sistemática.",
      ...
      { responsable: "EU. Marcos Soto", unidad: "Pabellón", problema: "Protocolo de posicionamiento desactualizado.",
    ...
    add("documentos", [
      { nombre: "Protocolo de prevención de LPP", tipo: "Protocolo", version: "2", fecha: iso(40), unidadResponsable: "UTI",
        responsable: "EU. Carolina Reyes", estado: "Vigente", envioCalidad: "Sí", fechaEnvio: iso(35), difusion: "Difundido en UTI y UCI", observaciones: "Actualizado con escala de Braden.", respaldo: "" },
      { nombre: "Procedimiento de vigilancia de accesos vasculares", tipo: "Procedimiento", version: "1", fecha: iso(20), unidadResponsable: "UCI",
      ...
      { nombre: "Flujo de valoración y manejo del dolor", tipo: "Flujograma", version: "1", fecha: iso(12), unidadResponsable: "Urgencia Adulto",
    ...
    add("actividades", [
      { fecha: iso(30), actividad: "Taller de prevención de LPP", tipo: "Taller", unidadResp: "UBPC", unidadesParticipantes: "UTI, UCI",
      ...
      { fecha: iso(18), actividad: "Capacitación en accesos vasculares", tipo: "Capacitación", unidadResp: "UBPC", unidadesParticipantes: "UCI",
      ...
      { fecha: iso(9), actividad: "Charla de manejo del dolor", tipo: "Charla", unidadResp: "UBPC", unidadesParticipantes: "Urgencia Adulto",
      ...
      { fecha: isoIn(10), actividad: "Simulación de posicionamiento", tipo: "Simulación", unidadResp: "UBPC", unidadesParticipantes: "Medicina",
    ...
    add("reuniones", [
      ...
      { fecha: iso(11), tipo: "Mesa técnica", tema: "Mesa técnica de dolor", unidad: "Urgencia Adulto", responsable: "EU. Marcos Soto", resultado: "Compromiso de estandarizar reevaluación." },
    ...
    add("solicitudes", [
      { direccion: "coord-a-ref", moduloOrigen: "Programa RNAO", solicitante: "EU. Carolina Reyes", fechaEnvio: iso(6), referente: refN,
        titulo: "Auditoría de accesos vasculares · UCI", unidad: "UCI", prioridad: "alta", plazo: isoIn(2),
      ...
      { direccion: "coord-a-ref", moduloOrigen: "Gestión Documental", solicitante: "EU. Carolina Reyes", fechaEnvio: iso(20), referente: refN,
        titulo: "Validación técnica del flujo de dolor", unidad: "Urgencia Adulto", prioridad: "media", plazo: iso(2),
    ...
    add("nt234", [
      ...
      { periodo: "2026-S1", unidad: "Pabellón", porcentaje: 74, indicadores: "LPP", observaciones: "" },
      { periodo: "2026-S1", unidad: "Medicina", porcentaje: 91, indicadores: "LPP", observaciones: "" }
    ], { silent: true });
    add("planesNT234", [
      { fechaSolicitud: iso(14), unidad: "Urgencia Adulto", indicadores: "Valoración y reevaluación del dolor", porcentaje: 63, plazo: isoIn(30), estado: "En curso", responsable: "EU. Marcos Soto", requiereReferente: "Sí", observaciones: "Intervención focalizada." },
      { fechaSolicitud: iso(8), unidad: "Pabellón", indicadores: "Prevención de LPP", porcentaje: 74, plazo: isoIn(45), estado: "Pendiente", responsable: "EU. Carolina Reyes", requiereReferente: "No", observaciones: "" }
    ], { silent: true });
    ...
    add("colaboraciones", [
      ...
      { fecha: iso(12), institucion: "Comité IAAS HUAP", contacto: "EU. Rocío Díaz", unidad: "UCI", objetivo: "Trabajo conjunto en accesos vasculares.",
    ...
    add("kanban", [
      ...
      kb("coordinador", "Difusión guía BPSO · Medicina", "En curso", "media", "EU. Marcos Soto", 12, 4),
      ...
      kb("referente", "Auditoría accesos · UCI", "Pendiente", "alta", "EU. Marcos Soto", 2, 1),
    ...
    add("capacitacionRef", [
      ...
      { fecha: iso(6), turno: "Largo", tema: "Vigilancia de accesos", unidad: "UCI", estamento: "TENS", participantes: 6, guia: "Accesos vasculares", observaciones: "" }
    ], { silent: true });
    add("evidenciaRef", [
      { tema: "Vigilancia diaria del sitio de inserción", fuente: "Guía práctica RNAO", autores: "RNAO", anio: "2024", nivelTipo: "Guía de práctica clínica", hallazgo: "La inspección diaria reduce complicaciones.", aplicabilidad: "Aplicable a UCI y UTI.", recomendacion: "Checklist diario de accesos.", enlace: "", guia: "Accesos vasculares" }
    ], { silent: true });
    add("monitoreoRef", [
      ...
      { fecha: iso(5), tipoRegistro: "Indicador", unidad: "UCI", guia: "Accesos vasculares", descripcion: "Medición de vigilancia.", resultado: "86%.", brecha: "Evaluación diaria.", intervencion: "Refuerzo en turno noche.", medioVerificacion: "", estado: "Completado" }
    ], { silent: true });

    /* ---------- Notificaciones ---------- */
    U.notif.push({ titulo: "Nueva solicitud técnica: Auditoría de accesos vasculares · UCI", modulo: "Solicitudes de apoyo", prioridad: "alta", destinatario: "referente", ref: "#/ref/solicitudesRecibidas" });
